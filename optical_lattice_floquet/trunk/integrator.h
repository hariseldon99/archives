...
#define ABSERROR 1e-8		/*Low Accuracy in order to run in a reasonable time, better value 1e-8 or 0 */
#define RELERROR 1e-5		/*Low Accuracy in order to run in a reasonable time, better value 1e-8or 1e-5 */
#define YERROR 0.5
